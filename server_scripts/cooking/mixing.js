ServerEvents.recipes(event => {
    event.recipes.gtceu.mixer('farmersdelight:wheat_dough')
        .itemInputs('#forge:eggs', '3x #forge:dusts/wheat')
        .itemOutputs('6x farmersdelight:wheat_dough')
        .EUt(GTValues.VA[GTValues.LV])
        .duration(400);

    event.recipes.gtceu.mixer('farmersdelight:wheat_dough_2')
        .itemInputs('3x #forge:dusts/wheat')
    ...
    event.recipes.gtceu.mixer('delightful:nut_dough')
        .itemInputs('2x #forge:nut_butter', 'minecraft:bone_meal', '#forge:eggs')
