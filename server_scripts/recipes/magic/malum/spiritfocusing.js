ServerEvents.recipes(event =>{
    ...
    dualSpiritFocusing("eldritch", "aqueous", "theurgy:mercury_shard", 8)
    ...
    //dualSpiritFocusing("sacred", "infernal", "")
    dualSpiritFocusing("sacred", "earthen", "hexerei:selenite_shard", 8)
    ...
    //dualSpiritFocusing("infernal", "aqueous", "")
