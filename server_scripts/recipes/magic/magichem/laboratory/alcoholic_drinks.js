ServerEvents.recipes(event => {
    ...
    //bnc
    //1 stage drinks - 30 essentia max, nigredo stone
    magichemicalLaboratory.distillFluidWithRequirement('brewinandchewin:beer',
        [
        ...
        1.0, 8, 1, "brewinandchewin:main/brew_drink"
    )
    magichemicalLaboratory.distillFluidWithRequirement('brewinandchewin:vodka',
        [
          { "item": "magichem:admixture_alcohol", "count": 20 },
    ...
    magichemicalLaboratory.distillFluidWithRequirement('brewinandchewin:mead',
        [
          { "item": "magichem:admixture_alcohol", "count": 20 },
          { "item": "magichem:admixture_nectar", "count": 8 },
          { "item": "magichem:essentia_nourishing", "count": 2 },
        ],
        1.0, 8, 6, "brewinandchewin:main/brew_drink"
    )
})