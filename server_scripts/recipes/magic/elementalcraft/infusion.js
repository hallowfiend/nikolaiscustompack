ServerEvents.recipes(event => {
    ...
    elementalcraftRecipes.infuse(
        ...
        500,
        "water",
        'kubejs:elementalcraft/infusion/drenched_invar'
    )
    elementalcraftRecipes.infuse(
        ...
        500,
        "air",
        'kubejs:elementalcraft/infusion/aerilated_silk'
    )
    elementalcraftRecipes.infuse(
        ...
        500,
        "fire",
        'kubejs:elementalcraft/infusion/burnt_glass'
    )
    elementalcraftRecipes.infuse(
        ...
        500,
        "earth",
        'kubejs:elementalcraft/infusion/cleanstone'
    )
})